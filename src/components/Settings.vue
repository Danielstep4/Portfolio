<template>
  <div>
    ...
    <div
      ...
      "
    >
      <div class="bg-white sm:w-auto sm:h-auto h-screen w-screen pb-8 relative">
        ...
        <div class="p-5 flex flex-col items-start">
          ...
          <div class="flex flex-row">
            <div
              v-for="clock in settings.clockContext"
        ...
        <div class="p-5 flex flex-row justify-between items-center">
          ...
          <div class="flex flex-row justify-between w-min">
            <div
              v-for="color in settings.colorContext"
...
export default defineComponent({
  ...
  methods: {
    ...
    checkIfTimeHasChanged(): boolean {
      let timeHasChanged: boolean = false;
      const { clockContext } = this.store.methods.getSettings();
      let i = 0;
      for (let { value } of this.settings.clockContext) {
        if (value != clockContext[i].value) timeHasChanged = true;
        i++;
      }
